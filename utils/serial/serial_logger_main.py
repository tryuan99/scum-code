...
def main(argv):
    ...
    logger = serial_logger.SerialLogger(FLAGS.port, FLAGS.baudrate, FLAGS.output_file, FLAGS.log_to_stderr)
    logger.run()
...
if __name__ == "__main__":
    ...
    flags.DEFINE_boolean("log_to_stderr", True, "If true, log the received data to standard error in addition to the output file.")
