...
if __name__ == "__main__":
    flags.DEFINE_string("port", "/dev/cu.usbmodem0006839038541",
                        "Serial port of the nRF board.")
    flags.DEFINE_string("binary", None,
                        "Binary image to flash onto the nRF board.")
